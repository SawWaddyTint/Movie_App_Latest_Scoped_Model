...
class ProductionCompaniesVOAdapter extends TypeAdapter<ProductionCompainesVO> {
  @override
  final int typeId = 8;

  @override
  ProductionCompainesVO read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ProductionCompainesVO obj) {
    writer
      ..writeByte(4)
      ..writeByte(0)
      ..write(obj.id)
